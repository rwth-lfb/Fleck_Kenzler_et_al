function [reg_ch1, reg_ch2, transformations_X, transformations_Y] = register(stack1, stack2)
...
for i = window_size:frames
    ...
    sliding_average = stack1(:,:,i) + stack2(:,:,i);
    for j=1:(window_size-1)
      sliding_average = sliding_average + stack1(:,:,i-j) + stack2(:,:,i-j); 
    end
    ...
    [reg_res_ch2, SUPPRORT] = iat_pixel_warping(stack2(:,:,i),VX,VY);
    reg_ch2 = cat(3, reg_ch2, reg_res_ch2);
    %reg_ch2_cell{i} = reg_res_ch2;
